...
import com.operr.todo.config.audit.AuditEventConverter;
import com.operr.todo.domain.PersistentAuditEvent;
...
import static com.operr.todo.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
